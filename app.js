...
var bankGuaranteeRouter       = require('./api/Transaction/Bank_Guarantee/Bank_Guarantee');
var bankTransactionRouter     = require('./api/Transaction/Bank_Transaction/Bank_Transaction');
...
var workUnitsRouter           = require('./api/Master/Work_Units/Work_Units');
...
app.use('/api/Master/Cheque', chequeRouter);
app.use('/api/Transaction/BankTransaction', bankTransactionRouter);
...
app.use('/api/Master/WorkUnits', workUnitsRouter);
