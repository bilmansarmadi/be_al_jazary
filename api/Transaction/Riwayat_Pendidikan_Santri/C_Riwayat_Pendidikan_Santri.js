...
module.exports = {
	Create:function(res, Data) {
		if (Data.Route === 'DEFAULT') {
            Data.tableColumn.r_pendidikan_id.value = ID.Read_Id(Data.TableName);
            if (DataValidation(Data)) {
                var ValidationArr = {
                    Table   : Data.TableName,
                    Field   : 'r_pendidikan_id',
                    Clause  : "r_pendidikan_id = '"+ Data.tableColumn.r_pendidikan_id.value +"'",
                    Return  : 'Boolean'
                };
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['nama_lengkap_santri','kode_santri']); 
