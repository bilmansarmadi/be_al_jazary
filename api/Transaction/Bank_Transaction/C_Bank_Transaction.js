    ...
    Create:function(res, Data) {
        if (Data.Route === 'DEFAULT') {
            ...
            if (DataValidation(Data)) {
                ...
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['payment_accepted', 'approval_by', 'modified_by', 'posted_by', 'date_approval', 'date_created', 'date_modified', 'date_posted', 'date_receipt', 'guarantee_id', 'status_receipt', 'status_escrow_accepted', 'approval_status', 'post_status']);
