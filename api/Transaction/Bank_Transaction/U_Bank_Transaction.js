    ...
    Update:function(res, Data) {
        if (Data.Route === 'DEFAULT') {
            if (DataValidation(Data)) {
                ...
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['bank_transaction_id', 'guarantee_id', 'payment_accepted', 'approval_by', 'created_by', 'posted_by', 'date_approval', 'date_created', 'date_posted', 'date_receipt', 'status_receipt', 'status_escrow_accepted', 'approval_status', 'post_status']);
            ...
            if (DataValidation(Data)) {
                ...
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['bank_transaction_id', 'no_voucher', 'workgroup_id', 'project_id', 'guarantee_id', 'bank_code', 'account_number', 'cheque_number', 'tax_invoice_number', 'invoice_number', 'street_mail_number', 'bank_transaction_desc', 'bank_transaction_date', 'bank_transaction_permission', 'bank_transaction_type', 'transaction_type', 'path_image', 'approval_by', 'created_by', 'modified_by', 'posted_by', 'date_approval', 'date_created', 'date_modified', 'date_posted', 'status_escrow_accepted', 'approval_status', 'post_status', 'status']);
