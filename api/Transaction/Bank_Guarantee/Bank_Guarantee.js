...
class Bank_Guarantee {
	...
	#tableColumn = {
		tableColumn: {
			...
			guarantee_address: {name: 'guarantee_address', datatype: 'varchar', length: 100, isNotNull: true, defaultvalue: '', value: null},
			...
			total_paid: {name: 'total_paid', datatype: 'decimal', length: 18.2, isNotNull: true, defaultvalue: 0.00, value: null},
			total_received: {name: 'total_received', datatype: 'decimal', length: 18.2, isNotNull: true, defaultvalue: 0.00, value: null},
