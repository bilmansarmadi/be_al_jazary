    ...
    Update:function(res, Data) {
        if (Data.Route === 'DEFAULT') {
            ...
            if (DataValidation(Data)) {
                ...
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['submission_number', 'workgroup_id', 'workgroup_partner_id', 'organizational_unit_id', 'sub_organizational_unit', 'work_unit_id', 'position_id', 'project_id', 'activity_id', 'bank_code', 'account_number', 'guarantee_id', 'submission_desc', 'submission_type', 'submission_permission', 'submission_financing', 'transaction_type', 'payment_status', 'money_status', 'submission_status', 'path_image_project', 'path_image_bank_guarantee', 'checking_by', 'approval_by', 'posted_by', 'created_by', 'modified_by', 'date_submission', 'date_posted', 'date_checking', 'date_approval', 'date_created', 'date_modified', 'date_published', 'date_end', 'upload_status', 'post_status', 'checking_status', 'approval_status', 'allocation_status', 'status_cashing']);
                let columnValueString = middleware.PrepareUpdateQuery(Data.tableColumn);
            ...
            if (DataValidation(Data)) {
                ...
                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['submission_number', 'workgroup_id', 'workgroup_partner_id', 'organizational_unit_id', 'sub_organizational_unit', 'work_unit_id', 'position_id', 'project_id', 'activity_id', 'bank_code', 'account_number', 'guarantee_id', 'submission_desc', 'submission_type', 'submission_permission', 'submission_financing', 'transaction_type', 'amount', 'payment_status', 'money_status', 'submission_status', 'path_image_project', 'path_image_bank_guarantee', 'checking_by', 'approval_by', 'posted_by', 'created_by', 'modified_by', 'date_submission', 'date_posted', 'date_checking', 'date_approval', 'date_created', 'date_modified', 'date_published', 'date_end', 'upload_status', 'post_status', 'checking_status', 'approval_status', 'allocation_status', 'status']);
                let columnValueString = middleware.PrepareUpdateQuery(Data.tableColumn);
