		...
		if (Data.Route === 'DEFAULT') {
			if (DataValidation(Data)) {
                var ValidationArr = {
                    ...
                    Field   : 'bank_code',
                    Clause  : "bank_name LIKE '%"+ Data.tableColumn.bank_name.value +"%'",
                    Return  : 'Boolean'
                };

                Data.tableColumn = middleware.ExcludeTableColumn(Data.tableColumn, ['bank_code_old', 'modified_by', 'date_created', 'date_modified']); 
