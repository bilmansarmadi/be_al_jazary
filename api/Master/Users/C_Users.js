...
module.exports = {
	Create:function(res, Data) {
		if (Data.Route === 'DEFAULT') {
            Data.tableColumn.user_id.value = ID.Read_Id(Data.TableName);

			if (DataValidation(Data)) {
                var ValidationArr = {
                    Table   : Data.TableName,
                    Field   : 'user_id',
                    Clause  : "user_id = '"+ Data.tableColumn.user_id.value +"'",
                    Return  : 'Boolean'
                };

                Data.tableColumn.user_password.value = md5(Data.tableColumn.user_password.value);

                Data.tableColumn        = middleware.ExcludeTableColumn(Data.tableColumn, ['date_created', 'date_modified']); 
